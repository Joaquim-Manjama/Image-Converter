...
const Format = ({ type, description, active}: FormatProp) => {
    return <div className={`bg-${active ? "[#222233]": "[#111111]"} w-[171px] ${active ? `border-3 border-[#3dd6c6]` : "border-2 border-gray-800"} flex flex-col justify-center rounded-lg p-[10px] font-bold select-none relative hover:${!active && "bg-[#222222]"}`}>
