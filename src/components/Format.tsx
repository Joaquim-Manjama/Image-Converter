...
const Format = ({ type, description, active}: FormatProp) => {
    return <div className={`bg-${active ? "[#1a2025]": "[#0d1117]"} w-[171px] border-3  ${active ? `border-[#3dd6c6]` : "border-[#2a3441]"} flex flex-col justify-center rounded-lg p-[10px] font-bold select-none cursor-pointer relative transition-all duration-300 hover:${!active && "bg-[#1a2025]"}`}>
